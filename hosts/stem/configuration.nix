...

{
  ...
  # Define a user account. Don't forget to set a password with ‘passwd’.
   users.users.twhitney = {
     ...
     openssh.authorizedKeys.keys = ["ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIBSeuF+NMj8sKD8kWuahlSasaPzHzT5Jhip+Y+EAcfEv trevorjwhitney@gmail.com"];
   };
  ...
  # services.kubernetes.masterAddress = "stem";
