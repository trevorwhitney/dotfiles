" -----------------------------------------------------------------------------
" File: gruvbox_less_red.vim
" Description: Retro groove color scheme for Vim with less Red
...
let g:colors_name='gruvbox_less_red'
...
if exists('g:gruvbox_invert_selection')
  if g:gruvbox_invert_selection == 0r
...
" overwrite red to something less confusing with errors
call s:HL('GruvboxRed', s:blue, s:none, s:bold)
...
" Generic statement
hi! link Statement GruvboxFg3Bold
